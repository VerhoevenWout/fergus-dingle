	...
	<div id="page-wrap"><!-- not needed? up to you: http://camendesign.com/code/developpeurs_sans_frontieres -->
		...
		<header id="header">
			<div class="col-md-10 col-md-offset-1">
				...
				<?php endif ?>
				<!-- <ul class="main-menu">
					<li><a href="<?php get_template_directory_uri()?>home/#work-wrapper">Work</a></li>
					<li class="divider">/</li>
					<li><a href="<?php get_template_directory_uri()?>home/#about-wrapper">About</a></li>
					<li class="divider">/</li>
					<li><a href="<?php get_template_directory_uri()?>home/#sponsor-wrapper">Clients</a></li>
					<li class="divider">/</li>
					<li><a href="<?php get_template_directory_uri()?>home/#contact-wrapper">Contact</a></li>
				</ul> -->
			</div>
		</header>
