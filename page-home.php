      ...
      <div class="col-md-10 col-md-offset-1">
        <div class="row">
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <a class="about-button about-button-filled" href="#contact-wrapper">contact</a>
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12">
            <?php $image = get_field('about_image', $home->ID);
  					if ($image) : ?>
  			    	<div class="about-img" style="background:transparent url('<?php echo $image; ?>') center no-repeat; background-size:cover;"></div>
  			  	<?php else : ?>
  			  		<div class="about-img" style="background:transparent url('<?php echo get_template_directory_uri(); ?>/images/fergus.png') center no-repeat; background-size:cover;"></div>
  			  	<?php endif; ?>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-10 col-md-offset-1">
        ...
        <div class="row">
          <div class="col-md-4 col-sm-4 col-xs-4 first-align icon-container">
            ...
            <p class="contact-icon-paragraph"><?php echo(encode_email(the_field('email', $home->ID))); ?></p>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-4 second-align icon-container">
            <img class="contact-icon" src="<?php echo get_bloginfo('template_url') ?>/assets/img/endcall-icon.png"/>
            	...
            	<p class="contact-icon-paragraph"><?php echo(encode_email(the_field('phone_number', $home->ID))) ?></p>
						</a>
